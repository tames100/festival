...
// 不再在触摸处理程序中使用 preventDefault（）。
// <canvas> 元素应用了“触摸操作：自动”样式.
 ...
 * 请求动画帧帮助程序。提供帧之间的经过时间和回调的滞后补偿乘数。
 * 
 * Author: Caleb Miller
 ...
 * 画布的超级简单的“舞台”抽象。结合 Ticker.js，它有助于简化：
